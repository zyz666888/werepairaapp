package com.idisfkj.hightcopywx.calendar.activity;
...
import com.idisfkj.hightcopywx.calendar.dialog.InputLocationDialog;
import com.idisfkj.hightcopywx.calendar.dialog.SelectDateDialog;
import com.idisfkj.hightcopywx.calendar.dialog.SelectEventSetDialog;
import com.idisfkj.hightcopywx.calendar.task.eventset.LoadEventSetMapTask;
import com.idisfkj.hightcopywx.calendar.task.schedule.UpdateScheduleTask;
import com.idisfkj.hightcopywx.calendar.utils.DateUtils;
import com.idisfkj.hightcopywx.calendar.utils.JeekUtils;
        ...
        if (requestCode == SelectEventSetDialog.ADD_EVENT_SET_CODE) {
            if (resultCode == AddEventSetActivity.ADD_EVENT_SET_FINISH) {
                ...
                if (eventSet != null) {
                    ...
                    sendBroadcast(new Intent(CalendarActivity.ADD_EVENT_SET_ACTION).putExtra(AddEventSetActivity.EVENT_SET_OBJ, eventSet));
                }
            }
        }
    }
