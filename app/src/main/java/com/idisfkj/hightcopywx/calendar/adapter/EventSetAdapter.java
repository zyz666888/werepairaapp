...
import com.idisfkj.hightcopywx.calendar.task.eventset.RemoveEventSetTask;
import com.idisfkj.hightcopywx.calendar.utils.JeekUtils;
import com.idisfkj.hightcopywx.calendar.widget.SlideDeleteView;
...
public class EventSetAdapter extends RecyclerView.Adapter<EventSetAdapter.EventSetViewHolder> {
    ...
    private void gotoEventSetFragment(EventSet eventSet) {
        if (mContext instanceof CalendarActivity) {
            ((CalendarActivity) mContext).gotoEventSetFragment(eventSet);
        }
    }
